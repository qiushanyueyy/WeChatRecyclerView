package com.yangy.wechatrecyclerview.view.MultiImageView;
...
import com.yangy.wechatrecyclerview.util.DensityUtil;
import com.yangy.wechatrecyclerview.view.ColorFilterImageView.ColorFilterImageView;
...
public class MultiImageView extends LinearLayout {
	...
	public void setList(List<ImageInfo> lists){
		if(lists != null ){
			imagesList = lists;
	...
	private ImageView createImageView(int position, final boolean isMultiImage) {
		...
		Glide.with(getContext()).load(imageInfo.url).diskCacheStrategy(DiskCacheStrategy.ALL).into(imageView);
